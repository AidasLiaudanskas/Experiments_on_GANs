"""
Loads the csv data taken from the TF summary files
(generated by extract_scalars.py)
data_to_load array should contain the width of the architectures we want to load.
"""
